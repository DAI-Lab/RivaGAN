...
class DenseEncoder(nn.Module):
    ...
    def __init__(self, data_dim, tie_rgb=False, linf_max=0.016, kernel_size=(1,5,5), padding=(0,2,2)):
        ...
        self._conv4 = nn.Sequential(
            nn.Conv3d(128, 1 if tie_rgb else 3, kernel_size=kernel_size, padding=padding, stride=1),
            nn.Tanh(),
        )
